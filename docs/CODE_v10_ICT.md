# XAUUSD SMC Pro v10 ICT — โค้ดเต็มสำหรับคัดลอก

สายตรงจาก v9 ต้นฉบับ: แก้บั๊กครบ 12 ข้อ + เพิ่มระบบเข้าไม้แบบ ICT
หน้าตาเหมือน v9 ทุกอย่าง (TP1/TP2, realtime, กล่อง FVG, ตาราง MTF, 0.01 lot)

อ่านวิธีใช้ที่ [V10_GUIDE.md](V10_GUIDE.md)

⚠️ ส่วน SMC แก้บั๊กแล้ว / ส่วน ICT **ยังไม่ผ่าน backtest** — เลือกโหมด
"SMC เท่านั้น" ถ้าต้องการเฉพาะ v9 ที่แก้บั๊กแล้ว
