...
var table t = table.new(position.top_right, 2, 15, bgcolor=color.new(#1a1a2e, 8), border_width=1, border_color=color.new(color.gray, 70))
if showPanel and barstate.islast
    ...
    table.cell(t, 1, 9, affordOK ? "เสี่ยง " + str.tostring(nextRisk, "#.#") + "%" : "ทุนไม่พอ (" + str.tostring(nextRisk, "#.#") + "%)", text_color=riskCol, text_size=size.tiny)
