# XAUUSD SMC Pro v9.4 LIVE — โค้ดเต็มสำหรับคัดลอก

indicator สำหรับเทรดมือ (demo / เงินจริง) เงื่อนไขเข้าไม้เหมือน v9.3
ที่ผ่านการทดสอบแล้วทุกบรรทัด อ่านวิธีใช้ที่ [LIVE_GUIDE.md](LIVE_GUIDE.md)
